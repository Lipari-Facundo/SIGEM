...
public interface IncidenteRepository extends JpaRepository<Incidente, Long> {
        ...
        List<Incidente> findByEstadoOrderByFechaAsignacionAsc(EstadoIncidente estado);
    ...
    boolean existsByAsignadoAIdAndEstadoIn(Long enfermeroId, List<EstadoIncidente> estados);

    Optional<Incidente> findFirstByAsignadoAIdAndEstadoInOrderByFechaAsignacionDesc(
            Long enfermeroId, List<EstadoIncidente> estados);
