...
const S = {
  ...
  main:        { flex: 1, background: '#F0F7F7', padding: '24px' },
  header:      { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '18px', gap: '14px', flexWrap: 'wrap' },
  ...
  modal:       { background: '#fff', borderRadius: '16px', padding: '24px', width: '100%', maxWidth: '680px', maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' },
  ...
  modalActions:{ display: 'flex', gap: '12px', justifyContent: 'flex-end', marginTop: '18px' },
};