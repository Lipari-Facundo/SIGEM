...
const S = {
  ...
  input:       { width: '100%', border: '1.5px solid #D6E4E3', borderRadius: '10px', padding: '10px 12px', fontSize: '13px', color: '#1F3838', outline: 'none', background: '#fff', boxSizing: 'border-box' },
  btnPrimary:  { background: '#0F5C68', color: '#fff', border: 'none', borderRadius: '10px', padding: '10px 20px', cursor: 'pointer', fontWeight: '700', fontSize: '13px' },
  btnSecondary:{ background: '#F0F7F6', color: '#0F5C68', border: '1px solid #D6E4E3', borderRadius: '10px', padding: '7px 12px', cursor: 'pointer', fontSize: '12px' },
  table:       { width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' },
  th:          { textAlign: 'left', padding: '11px 12px', borderBottom: '2px solid #EDEDED', color: '#354B4C', fontSize: '13px', fontWeight: '700', whiteSpace: 'normal' },
  td:          { padding: '11px 12px', borderBottom: '1px solid #F0F3F3', color: '#334449', fontSize: '13px', verticalAlign: 'middle', whiteSpace: 'normal', wordBreak: 'break-word' },
  empty:       { padding: '28px', color: '#7F8C8D', textAlign: 'center' },
