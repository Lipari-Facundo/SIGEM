...
const S = {
  sidebar:  { width: '220px', minHeight: '100vh', background: '#0d1117', display: 'flex', flexDirection: 'column', flexShrink: 0, fontFamily: "'Segoe UI', sans-serif" },
  logo:     { display: 'flex', alignItems: 'center', gap: '12px', padding: '24px 20px', borderBottom: '1px solid #21262d' },
  ...
  navItem:  { display: 'flex', alignItems: 'center', gap: '10px', background: 'transparent', border: 'none', color: '#8b949e', padding: '10px 14px', borderRadius: '8px', textAlign: 'left', cursor: 'pointer', fontSize: '14px', width: '100%', fontWeight: '500', transition: 'all 0.15s' },
  navActive:{ background: '#161b22', color: '#fff' },
  navIcon:  { fontSize: '16px', width: '20px', textAlign: 'center' },
  userBox:  { display: 'flex', alignItems: 'center', gap: '10px', padding: '16px', borderTop: '1px solid #21262d' },
  avatar:   { width: '36px', height: '36px', borderRadius: '50%', flexShrink: 0, background: 'linear-gradient(135deg, #1B6B6B, #4CAF50)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '700', fontSize: '13px' },
  ...
  logoutBtn:{ background: 'transparent', border: 'none', color: '#8b949e', cursor: 'pointer', fontSize: '18px', padding: '4px', flexShrink: 0 },
};
